...
var trashmaterial =[new THREE.MeshStandardMaterial({ color: 0xffe600 }),new THREE.MeshStandardMaterial({ color: 0x002193 }),new THREE.MeshStandardMaterial({ color: 0x009321 })]
